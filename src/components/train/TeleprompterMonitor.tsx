...
export default function TeleprompterMonitor({
  ...
  return (
    <div className="order-1 lg:order-2 flex-1 flex flex-col bg-[#050507] border-r border-white/5 relative min-h-[320px] sm:min-h-[500px]">
      ...
      {selectedText ? (
        <>
          ...
          <div
            ...
            className="flex-1 overflow-y-auto px-4 sm:px-6 md:px-16 py-8 sm:py-20 md:py-32 space-y-6 scroll-smooth select-none relative"
          ...
          <footer className="bg-[#09090d] border-t border-white/5 flex flex-col md:flex-row items-center justify-between p-4 md:p-5 md:px-10 gap-3 md:gap-4 z-30">
